...
(function ($) {
	...
	// $('.element-section').on('mouseenter', '.element-card', function () {
	// 	$(this).find('.element-card-image').css('opacity', 1);
	// }).on('mouseleave', '.element-card', function () {
	// 	$(this).find('.element-card-image').css('opacity', 0);
	// });
